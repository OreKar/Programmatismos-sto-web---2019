...
<div class="container login-container">
            <div class="row">
                <div class="col-md-6 login-form-1">
                    <h3>Assign Movie To Cinemas</h3>
                    <form action="AssignToCinema" method="post">
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="ID" value="" name="id"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Your Content Admin ID" value="" name="contentadmin_id"/>
                        </div>
                        <div class="form-group">
